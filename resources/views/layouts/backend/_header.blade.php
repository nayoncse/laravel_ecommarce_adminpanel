...
<a href="index.html" class="logo">
    <!-- mini logo -->
    <b class="logo-mini">
        <span class="light-logo"><img src="{{ asset('assets/backend/images/logo-light.png') }}" alt="logo"></span>
        <span class="dark-logo"><img src="{{ asset('assets/backend/images/logo-dark.png') }}" alt="logo"></span>
    </b>
    <!-- logo-->
    <span class="logo-lg">
		  <img src="{{ asset('assets/backend/images/logo-light-text.png') }}" alt="logo" class="light-logo">
	  	  <img src="{{ asset('assets/backend/images/logo-dark-text.png') }}" alt="logo" class="dark-logo">
	  </span>
</a>
<!-- Header Navbar -->
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                    ...
                    <li>
                        ...
                        <ul class="menu inner-content-div">
                            <li><!-- start message -->
                                <a href="#">
                                    <div class="pull-left">
                                        <img src="{{ asset('assets/backend/images/user2-160x160.jpg') }}" class="rounded-circle" alt="User Image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        <img src="{{ asset('assets/backend/images/user3-128x128.jpg') }}" class="rounded-circle" alt="User Image">
                                    </div>
                                    <div class="mail-contnet">
                                        <h4>
                                            Nullam tempor
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        <img src="{{ asset('assets/backend/images/user4-128x128.jpg') }}" class="rounded-circle" alt="User Image">
                                    </div>
                                    <div class="mail-contnet">
                                        <h4>
                                            Proin venenatis
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{ asset('assets/backend/images/user5-128x128.jpg') }}" class="user-image rounded-circle" alt="User Image">
                </a>
                <ul class="dropdown-menu scale-up">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="{{ asset('assets/backend/images/user5-128x128.jpg') }}" class="float-left rounded-circle" alt="User Image">
